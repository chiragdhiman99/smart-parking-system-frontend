          ...
          {locations.map((loc, i) => (
            ...
            >
              ...
              >
                {loc.emoji}
                <span
                  className={`absolute top-3 right-3 text-xs font-bold px-2.5 py-1 rounded-lg ${loc.badge === "green" ? "bg-white text-green-700" : "bg-white text-yellow-600"}`}
                >
                  {loc.badge === "green" ? "🟢" : "🟡"} {loc.slots} Free
                </span>
              </div>
              <div className="p-4">
