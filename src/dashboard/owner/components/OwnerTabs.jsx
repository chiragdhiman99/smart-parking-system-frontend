        ...
        {ownerparking.length === 0 ? (
          <>
            ...
            <button
              ...
              className="bg-white text-blue-600 font-bold px-6 py-2.5 rounded-xl text-sm cursor-pointer hover:bg-blue-50 transition-all flex items-center gap-2 mx-auto"
            >
              <Plus className="w-4 h-4" /> Add Your First Parking
            </button>
          </>
        ) : (
          <>
            <PartyPopper className="w-10 h-10 mx-auto mb-3 text-white/80" />
  ...
  >
    <div className="flex items-center justify-between mb-2">
      ...
      <button
        ...
        className="bg-[#3B82F6] text-white font-bold px-4 py-2 rounded-xl text-xs cursor-pointer hover:bg-blue-600 transition-all flex items-center gap-1.5"
      >
        <Plus className="w-3.5 h-3.5" /> Add New Parking
      </button>
    </div>
    ...
    {ownerparking.length > 0 ? (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 text-sm mb-4">
              <p className="text-gray-500 flex items-center gap-1">
                <ParkingSquare className="w-3.5 h-3.5" /> Slots:{" "}
              ...
              <p className="text-gray-500 flex items-center gap-1">
                <Car className="w-3.5 h-3.5" /> Types:{" "}
                <span className="font-bold text-gray-900">
              ...
              <p className="text-gray-500 flex items-center gap-1">
                <CheckSquare className="w-3.5 h-3.5" /> Auto:{" "}
                <span className="font-bold text-gray-900">
      ...
      <div className="bg-gray-50 rounded-2xl p-12 text-center border-2 border-dashed border-gray-200">
        <ParkingSquare className="w-10 h-10 mx-auto mb-3 text-gray-300" />
        ...
        <button
          onClick={() => setShowForm(true)}
          className="bg-[#3B82F6] text-white font-bold px-6 py-2.5 rounded-xl text-sm cursor-pointer hover:bg-blue-600 transition-all flex items-center gap-2 mx-auto"
        >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 bg-gray-50 rounded-xl p-3">
              <div>
                ...
                <p className="text-sm font-black text-gray-900 flex items-center gap-1">
                  <ParkingSquare className="w-3.5 h-3.5" /> {booking.slot}
                </p>
              </div>
              <div>
                <p className="text-[10px] text-gray-400 font-semibold uppercase">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-gray-900 flex items-center gap-1">
                  <Clock className="w-3.5 h-3.5" /> {booking.fromTime}
                </p>
              </div>
              <div>
                <p className="text-[10px] text-gray-400 font-semibold uppercase">
                ...
                <p className="text-sm font-bold text-gray-900 flex items-center gap-1">
                  <Clock className="w-3.5 h-3.5" /> {booking.toTime}
                </p>
              </div>
            </div>
