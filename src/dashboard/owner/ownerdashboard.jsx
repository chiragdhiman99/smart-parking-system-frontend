...
const OwnerDashboard = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://smart-parking-system-backend-o9o9.onrender.com/api/parkings/owner/${decoded.userId}`,
      )
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://smart-parking-system-backend-o9o9.onrender.com/api/bookings/${decoded.userId}`,
      )
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://smart-parking-system-backend-o9o9.onrender.com/api/notifications/${decoded.userId}`,
      )
      .then((res) =>
  ...
  const markAllRead = useCallback(() => {
    axios
      .put(
        `https://smart-parking-system-backend-o9o9.onrender.com/api/notifications/read/${decoded.userId}`,
      )
      .then(() =>
  ...
  const handleSaveEdit = useCallback(() => {
    axios
      .put(
        `https://smart-parking-system-backend-o9o9.onrender.com/api/parkings/${editingParking._id}`,
        {
          name: editForm.name,
