...
const ParkingDetail = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://smart-parking-system-backend-production-6aac.up.railway.app/api/parkings/${parkingid}`)
      .then((response) => {
        const total =
  ...
  useEffect(() => {
    axios
      .get(`https://smart-parking-system-backend-production-6aac.up.railway.app/api/bookings/parking/${parkingid}`)
      .then((response) => {
