...
const ParkingDetail = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://smart-parking-system-backend-o9o9.onrender.com/api/parkings/${parkingid}`)
      .then((response) => {
        const total =
  ...
  useEffect(() => {
    axios
      .get(`https://smart-parking-system-backend-o9o9.onrender.com/api/bookings/parking/${parkingid}`)
      .then((response) => {
