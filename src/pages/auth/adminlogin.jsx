...
export default function AdminLogin() {
  ...
  return (
    <div className="flex min-h-screen font-sans">
      <div className="w-[45%] bg-gradient-to-br from-green-800 to-green-500 text-white p-10 flex flex-col relative overflow-hidden">
        ...
        <div className="my-auto z-10">
          ...
          <div className="flex gap-4">
            <div className="bg-white/20 backdrop-blur-md rounded-xl px-5 py-3 flex flex-col items-center">
              <span className="text-lg font-extrabold">500+</span>
              <span className="text-xs opacity-80 mt-1">Locations</span>
            </div>

            <div className="bg-white/20 backdrop-blur-md rounded-xl px-5 py-3 flex flex-col items-center">
              <span className="text-lg font-extrabold">4.9★</span>
              <span className="text-xs opacity-80 mt-1">Rating</span>
            </div>

            <div className="bg-white/20 backdrop-blur-md rounded-xl px-5 py-3 flex flex-col items-center">
              <span className="text-lg font-extrabold">50K+</span>
              <span className="text-xs opacity-80 mt-1">Drivers</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-10 w-full max-w-md shadow-lg">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
              ...
              <AnimatePresence>
                {error && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="absolute -top-2 left-0 text-red-500 text-xs font-medium"
                  >
                    ✕ {error}
                  </motion.div>
                )}
            ...
            <button
              type="submit"
              disabled={loading}
              className={`mt-2 py-4 rounded-xl text-white font-bold text-sm transition 
              bg-gradient-to-r from-green-500 to-green-800 shadow-md
